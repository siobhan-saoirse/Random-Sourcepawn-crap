...
new Handle:g_cvarRotation = INVALID_HANDLE;
...
public OnPluginStart() {
	...
	g_cvarRotation = CreateConVar("sm_helpmenu_rotation", "1", "Shows the map rotation in the menu.", FCVAR_PLUGIN);
	RegConsoleCmd("sm_helpmenu", Command_HelpMenu, "Display the help menu.", FCVAR_PLUGIN);
	RegConsoleCmd("sm_helpcommands", Command_HelpMenu, "Display the help menu.", FCVAR_PLUGIN);
	RegConsoleCmd("sm_helpcomands", Command_HelpMenu, "Display the help menu.", FCVAR_PLUGIN);
	RegConsoleCmd("sm_helpcommand", Command_HelpMenu, "Display the help menu.", FCVAR_PLUGIN);
	RegConsoleCmd("sm_helpcomand", Command_HelpMenu, "Display the help menu.", FCVAR_PLUGIN);
	RegConsoleCmd("sm_commands", Command_HelpMenu, "Display the help menu.", FCVAR_PLUGIN);
	RegConsoleCmd("sm_comands", Command_HelpMenu, "Display the help menu.", FCVAR_PLUGIN);
	RegConsoleCmd("sm_cmds", Command_HelpMenu, "Display the help menu.", FCVAR_PLUGIN);
	RegConsoleCmd("sm_cmd", Command_HelpMenu, "Display the help menu.", FCVAR_PLUGIN);
