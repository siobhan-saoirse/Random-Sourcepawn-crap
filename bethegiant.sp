...
public OnPluginStart()
{
	...
	cvarCooldown = CreateConVar("sm_bethegiant_cooldown", "3.0", "If greater than 0, players must wait this long between enabling/disabling robot on themselves. Set to 0.0 to disable.", FCVAR_NONE, true, 0.0);
